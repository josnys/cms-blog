     ...
     return (<section id={content.id ?? ''} className={`w-full py-4 md:py-8 ${className}`}>
          <div className="w-full col-span-12 py-5 md:container md:py-10 md:mx-auto">
               <div className="w-full text-slate-600">
                    ...
                    {content.description ? <article className="w-full p-4 mx-auto mt-4 prose text-justify md:p-0 md:w-1/2 max-w-none prose-md" dangerouslySetInnerHTML={{ __html: content.description }}></article> : null}
